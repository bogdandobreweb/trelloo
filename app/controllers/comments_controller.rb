class CommentsController < ApplicationController
  ...
  before_action :set_story, only: %i[index create]
  ...
  def create
    ...
    comment = comment_creator.call(comment_params_for_create.merge(user_id: current_user.id,
