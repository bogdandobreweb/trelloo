...
# require '../../app/services/boards/board_updater.rb'
# require '../../app/services/base_updater.rb'
...
RSpec.describe BaseUpdater do
  ...
  describe '.call' do
    ...
    context 'when record is not found' do
      let(:attrs) { { id: 0 } }
      it 'raises error' do
        expect { board_updater.call(attrs) }.to raise_error(ActiveRecord::RecordNotFound)
      end
    end
